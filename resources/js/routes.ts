...
export const routes = {
  ...
  environmentBuilds: (applicationID: string, environmentID: string) => `/applications/${applicationID}/environments/${environmentID}/builds`,
  ...
  environmentReleases: (applicationID: string, environmentID: string) => `/applications/${applicationID}/environments/${environmentID}/releases`,
  environmentRestart: (applicationID: string, environmentID: string) => `/applications/${applicationID}/environments/${environmentID}/restart`,
  ...
  resourceDatabaseEditor: (id: string, databaseName: string) => `/resources/${id}/databases/${databaseName}/editor`,
  resourceDatabaseEditorQuery: (id: string, databaseName: string) => `/resources/${id}/databases/${databaseName}/editor/query`,
  ...
  systemHostCapabilities: () => '/system/host/capabilities',
  systemHostContainersControl: () => '/system/host/containers/control',
  systemHostContainersLogs: () => '/system/host/containers/logs',
  systemHostImagesRemove: () => '/system/host/images/remove',
  systemHostPrune: () => '/system/host/prune',
  systemHostReboot: () => '/system/host/reboot',
  systemHostUpdatesApply: () => '/system/host/updates/apply',
  systemHostUpdatesCheck: () => '/system/host/updates/check',

...
<script lang="ts">
  ...
  let { open = $bindable(false), deployment }: { open?: boolean; deployment: Deployment | null } = $props()
  ...
  <Dialog.Content class="sm:max-w-6xl">
    {#if deployment}
      <Dialog.Header>
        ...
        <Dialog.Description>{deployment.changeSummary || 'System deployment details and activity.'}</Dialog.Description>
      </Dialog.Header>
        ...
        <section>
          ...
          <dl class="mt-4 grid gap-x-8 gap-y-5 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="sm:col-span-2 xl:col-span-4">
              ...
              <dd class="mt-1 break-all font-mono text-xs">{deployment.artifactReference || 'Not recorded'}</dd>
            </div>
            <div class="sm:col-span-2 xl:col-span-4">
        ...
        <section>
          ...
          <dl class="mt-4 grid gap-x-8 gap-y-5 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="sm:col-span-2 xl:col-span-4">
              ...
              <dd class="mt-1 text-sm">{deployment.changeSummary || 'Not recorded'}</dd>
            </div>
          </dl>
        </section>

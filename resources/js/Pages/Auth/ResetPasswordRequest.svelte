...
<Layout>
  <AuthCard title="Reset your password" description="Enter your email address and we will send you a reset code.">
    ...
    {#snippet footer()}
      <p class="text-xs">
        ...
        <Link class="text-primary underline-offset-4 hover:underline" href={routes.sessionNew()}>Sign in</Link>
      </p>
    {/snippet}
  </AuthCard>
</Layout>

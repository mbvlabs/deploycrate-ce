<script lang="ts">
  ...
  type Credential = { id: string; name: string; role: string; username: string; metadata: unknown; hasEncryptedPayload: boolean; installationId: string }

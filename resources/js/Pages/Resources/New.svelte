    ...
    <div class="mx-auto max-w-5xl space-y-8">
      ...
      <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {#each availableEngines as engine}
          ...
          <button type="button" onclick={() => chooseEngine(engine)} class="group flex min-h-48 flex-col border border-border bg-card p-5 text-left transition-colors hover:border-primary/60 hover:bg-muted/30">

...
var CaddyRouteShow = routing.NewRouteWithStringID(
	"/routes/:id",
	"caddy-routes.show",
	CaddyRoutesPrefix,
)
...
var CaddyRouteDestroy = routing.NewRouteWithUUIDID(
	"/:id",
	"caddy-routes.destroy",
	CaddyRoutesPrefix,
)

var CaddyResourceRouteUpdate = routing.NewRouteWithUUIDID(
	"/resource-routes/:id",

...
var ResourceConnectionEnvironmentKeysUpdate = routing.NewRouteWithParams[ResourceConnectionParams](
	"/:id/connections/:connectionID/environment-keys",
	"resources.connections.environment-keys.update",
	ResourcesPrefix,
)

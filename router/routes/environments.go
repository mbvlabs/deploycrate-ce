...
var EnvironmentStart = routing.NewRouteWithParams[EnvironmentParams]("/:applicationID/environments/:environmentID/start", "applications.environments.start", ApplicationsPrefix)
var EnvironmentSecrets = routing.NewRouteWithParams[EnvironmentParams]("/:applicationID/environments/:environmentID/secrets", "applications.environments.secrets", ApplicationsPrefix)
...
var EnvironmentPromoteToProduction = routing.NewRouteWithParams[EnvironmentParams]("/:applicationID/environments/:environmentID/promote-to-production", "applications.environments.promote-to-production", ApplicationsPrefix)
...
var EnvironmentReleaseCommandLogs = routing.NewRouteWithParams[EnvironmentReleaseCommandParams]("/:applicationID/environments/:environmentID/release-commands/:executionID/logs", "applications.environments.release_commands.logs", ApplicationsPrefix)
var EnvironmentReleaseCommandRetry = routing.NewRouteWithParams[EnvironmentReleaseCommandParams]("/:applicationID/environments/:environmentID/release-commands/:executionID/retry", "applications.environments.release_commands.retry", ApplicationsPrefix)

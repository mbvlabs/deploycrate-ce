...
var RegistryResourceShow = routing.NewRouteWithUUIDID("/:id", "registry-resources.show", RegistryResourcesPrefix)
var RegistryResourceDestroy = routing.NewRouteWithUUIDID("/:id", "registry-resources.destroy", RegistryResourcesPrefix)
var RegistryResourceCredentials = routing.NewRouteWithUUIDID("/:id/credentials", "registry-resources.credentials", RegistryResourcesPrefix)

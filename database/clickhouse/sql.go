...
var (
	...
	caddyRequestsQuery              = mustQuery("caddy_requests")
	...
	insertRequestObservationsQuery  = mustQuery("insert_request_observations")
	latestAttributedMetricsQuery    = mustQuery("latest_attributed_metrics")
	latestRequestObservationQuery   = mustQuery("latest_request_observation")
	latestSystemMetricsQuery        = mustQuery("latest_system_metrics")
	recentTracesQuery               = mustQuery("recent_traces")
	requestCountriesQuery           = mustQuery("request_countries")
	requestPathsQuery               = mustQuery("request_paths")

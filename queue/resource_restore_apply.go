...
func NewDatabaseRestoreApplyWorker(
	service *services.DatabaseRestoreWorkflow,
) *DatabaseRestoreApplyWorker {
...
func (worker *DatabaseRestoreApplyWorker) Timeout(
	*river.Job[jobs.DatabaseRestoreApplyArgs],
) time.Duration {
	return 12 * time.Hour
}

func (worker *DatabaseRestoreApplyWorker) Work(
	ctx context.Context,
	job *river.Job[jobs.DatabaseRestoreApplyArgs],
) error {
